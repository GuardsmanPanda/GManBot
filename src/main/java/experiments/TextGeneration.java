...
public class TextGeneration extends ListenerAdapter {
    ...
    private static void loadTextModel() {
        List<String> textList = BobsDatabase.getListFromSQL("SELECT chatLine FROM ChatLines WHERE LENGTH(chatLine) > 20 ORDER BY timeStamp DESC FETCH FIRST 800000 ROWS ONLY", String.class);
